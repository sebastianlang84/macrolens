...
- Workbench-RSI-Charts markieren `30` und `70` jetzt visuell als ueberverkauft/ueberkauft, aber nur dann, wenn das sichtbare Panel ausschliesslich aus RSI-/RSI-Score-Reihen besteht.
